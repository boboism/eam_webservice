...
class AdjDocF20 < ActiveRecord::Base
  self.table_name = "vw_erp_f20"
  self.primary_key = "id"
end
...
ws_attrs = {
  :interface => {:sender => "EAM", :receiver => "ERP", :billtype => "F20"},
  :func_name => "FixedAssetAdjustValue",
  :handshake => "654321"
}
receivable_docs = []
unreceivable_docs = []
AdjDocF20.all.each do |doc|
